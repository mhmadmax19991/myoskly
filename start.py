        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ قناة البوت ›", url=f"https://t.me/oooox6"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "‹ Krezy Team ›", url="https://t.me/rq_ok"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("‹ قناة السوࢪس ›", url=f"https://t.me/rq_ok"),
                InlineKeyboardButton(
                    "‹ مطور السوࢪس ›", url=f"https://t.me/M_X_FF"
                ),
            ]
        ]
    )
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("‹ قناة السوࢪس ›", url=f"https://t.me/rq_ok"),
                InlineKeyboardButton(
                    "‹ مطور السورس ›", url=f"https://t.me/M_X_FF"
                ),
            ]
        ]
    )

    alive = f"**هلا {message.from_user.mention()}, i'm {BOT_NAME}**\n\n※︙اهلا بك في سوࢪس ڪريزي\n※︙اختصاص البوت تشغيل الموسيقى و الفيديو في الدردشة الصوتية \n\n**※︙تابع القناة الرسمية: @rq_ok** ※"
